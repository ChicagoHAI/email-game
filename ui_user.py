...
from ui_components.shared_components import (
    add_separator, 
...
def handle_multi_turn_level(session_id, level, scenario_content, model, api_keys_available):
    ...
    if show_input:
        # Add separator before email input section
        from ui_components.shared_components import add_separator
        add_separator()
...
def handle_single_turn_level(session_id, level, scenario_content, model, api_keys_available):
    ...
    email_content = create_level_email_input(level, api_keys_available)
